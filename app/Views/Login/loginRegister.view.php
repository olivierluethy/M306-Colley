...
<body>
    ...
    <script src="public/js/Login/password_strength_checker.js"></script>
    <script src="public/js/Login/clientSideValidationRegister.js"></script>
    <script src="public/js/Login/clientSideValidationLogin.js"></script>
</body>
